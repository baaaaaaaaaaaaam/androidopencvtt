...
Java_com_login_tt_MainActivity_ConvertRGBtoGray(JNIEnv *env, jobject instance, jlong matAddrInput,
                                                jlong matAddrResult) {
...
Java_com_login_tt_MainActivity_loadCascade(JNIEnv *env, jobject instance,
...
JNIEXPORT void JNICALL
Java_com_login_tt_MainActivity_detect(JNIEnv *env, jobject instance, jlong cascadeClassifier_face,jlong cascadeClassifier_eyes,
                                      jlong matAddrInput, jlong matAddrResult,jint choice) {
